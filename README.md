...
- [4.2. Tactical-Level Domain-Driven Design](#42-tactical-level-domain-driven-design)
    ...
    - [4.2.2. Bounded Context: Gobierno Institucional](#42x-bounded-context--bounded-context-name)
    ...
    - [4.2.3. Bounded Context: Gestión de Dispositivos IoT & Activos](#42x-bounded-context--bounded-context-name)
    ...
    - [4.2.4. Bounded Context: Telemetría & Monitoreo](#42x-bounded-context--bounded-context-name)
    ...
    - [4.2.5. Bounded Context: Notificaciones & Workflows	](#42x-bounded-context--bounded-context-name)
        - [4.2.5.1. Domain Layer](#42x1-domain-layer)
        - [4.2.5.2. Interface Layer](#42x2-interface-layer)
        - [4.2.5.3. Application Layer](#42x3-application-layer)
        - [4.2.5.4. Infrastructure Layer](#42x4-infrastructure-layer)
        - [4.2.5.5. Bounded Context Software Architecture Component Level Diagrams](#42x5-bounded-context-software-architecture-component-level-diagrams)
        - [4.2.5.6. Bounded Context Software Architecture Code Level Diagrams](#42x6-bounded-context-software-architecture-code-level-diagrams)
          - [4.2.5.6.1. Bounded Context Domain Layer Class Diagrams](#42x61-bounded-context-domain-layer-class-diagrams)
          - [4.2.5.6.2. Bounded Context Database Design Diagram](#42x62-bounded-context-database-design-diagram)
    - [4.2.6. Bounded Context: Inventario & Stock (FEFO)	](#42x-bounded-context--bounded-context-name)
        - [4.2.6.1. Domain Layer](#42x1-domain-layer)
        - [4.2.6.2. Interface Layer](#42x2-interface-layer)
        - [4.2.6.3. Application Layer](#42x3-application-layer)
        - [4.2.6.4. Infrastructure Layer](#42x4-infrastructure-layer)
        - [4.2.6.5. Bounded Context Software Architecture Component Level Diagrams](#42x5-bounded-context-software-architecture-component-level-diagrams)
        - [4.2.6.6. Bounded Context Software Architecture Code Level Diagrams](#42x6-bounded-context-software-architecture-code-level-diagrams)
          - [4.2.6.6.1. Bounded Context Domain Layer Class Diagrams](#42x61-bounded-context-domain-layer-class-diagrams)
          - [4.2.6.6.2. Bounded Context Database Design Diagram](#42x62-bounded-context-database-design-diagram)
